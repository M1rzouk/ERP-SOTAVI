// components/SearchBar.jsx - Fixed version with maxHeight: 370
...
export default function SearchBar({ variant, onSearch, onClose, autoFocus }) {
        ...
        >
          ...
          >
            <StyledPaper elevation={3}>
              ...
              {/* Added maxHeight and overflow auto to the list */}
              <List dense sx={{ py: 0, maxHeight: 370, overflowY: 'auto' }}>
  ...
  // Mobile: show search bar with close button
  return (
    <Box sx={{ position: 'relative', width: '100%' }}>
      ...
      >
        <StyledPaper elevation={3}>
          {/* Added maxHeight and overflow auto to the mobile list */}
          <List dense sx={{ maxHeight: 370, overflowY: 'auto' }}>
            {suggestions.map((sug, idx) => (
              <StyledListItem
                button
                key={idx}
